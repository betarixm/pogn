...
const ProfilePanel = ({
 ...
 className="w-full rounded-xl bg-white/50 px-3 py-2 text-sm text-zinc-100 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-postech-500/20 bg-white/5 text-zinc-100 placeholder-zinc-600"
 />
 </div>
 ...
 className="shrink-0 rounded-xl border border-zinc-700 px-3 py-1.5 text-xs font-medium text-zinc-300 transition-colors hover:border-zinc-600 hover:bg-zinc-800/60"
 >
 편집
 </button>
 )}
